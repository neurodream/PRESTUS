function [parameters] = get_transducer_pos(parameters, sbj_ID, side, transd_ind, transd_angle, transd_pos_add, target_pos_add)
...
parameters.transducers(transd_ind).focus_pos_t1_grid = round(defacto_target([2 1 3]));  % flip back to normal space
