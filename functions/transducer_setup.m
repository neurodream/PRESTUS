...
% TODO in general: why have a new variable transducer_pars, why not read
% out from parameters instead?
...
for transducer = transducer_pars
    ...
    if isequal(size(focus_pos), [3 1]) % TODO isn't that non-inclusive for 2D simulations?
        focus_pos = focus_pos';
        trans_pos = trans_pos';
