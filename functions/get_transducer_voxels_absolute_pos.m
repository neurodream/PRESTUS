function [transducer_voxels] = get_transducer_voxels_absolute_pos(target, trans_pos, matter, parameters, patch_name, transducer_color)
    ...
    line = plot3( ...
        ...
        'Color', transducer_color, 'LineWidth', 1); %
    
    line.Tag = patch_name;
    add_transducer_shape(trans_pos, target, 'Parameters', parameters, 'TargetType', 'none', 'PatchName', char(patch_name), 'Color', transducer_color);
