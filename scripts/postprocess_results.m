...
for id_idx = 1:numel(IDs)
    ...
    T = table( ...
        ...
        [p_skull; i_skull], ...
        [p_brain; i_brain], ...
        [p_brain_inner; i_brain_inner], ...
        [p_targetL; i_targetL], ...
        [p_targetR; i_targetR], ...
        [p_ROItarget_L_max; i_ROItarget_L_max], ...
        [p_ROItarget_R_max; i_ROItarget_R_max], ...
        [p_ROItarget_L_avg; i_ROItarget_L_avg], ...
        [p_ROItarget_R_avg; i_ROItarget_R_avg], ...
        ...
        'RowNames', {['pressure_' ID], ['intensity_' ID]} ...
    );
