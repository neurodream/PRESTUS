...
prefix_unilateral_r = '_L+y+z--r+z_R+y+z--r+z_';
prefix_unilateral_l = '_L+y+z--l+z_R+y+z--l+z_';
...
nifti_path = sprintf('/home/sleep/nicade/Documents/scans/segmentation_results/m2m_sub-%03d/final_tissues.nii.gz', sub_id);
...
IDs = {prefix_bilateral};
IDs = {prefix_unilateral_r};
IDs = {prefix_unilateral_r, prefix_bilateral};
