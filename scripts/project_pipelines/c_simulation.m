...
expected_focal_distance_mm = 65.0; % hardcoding here because don't want to set param in config file, which may lead to incorrect focussing down the road (?)
...
for i = 1:size(targets, 1)
    ...
    real_profile = readmatrix(fullfile(pn.profiles, [transducer_name, '.csv']));
...
% TODO figure out why commented out & what this code does
